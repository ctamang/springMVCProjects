...
public class Create {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor tempInstructor = new Instructor("chandan", "tamang", "chandan12@gmail.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.chandan.com", "guitar");
